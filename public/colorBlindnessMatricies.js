//Transformation matricies that represent the
//different types and severities of colorblindness
//R[0], G[1], B[2]

const protanopiaMatrix = (severity) => {
  switch (severity) {
    case 0.1:
      return [
...
const deuteranopiaMatrix = (severity) => {
  switch (severity) {
    case 0.1:
      return [
...
const tritanopiaMatrix = (severity) => {
  switch (severity) {
    case 0.1:
      return [
